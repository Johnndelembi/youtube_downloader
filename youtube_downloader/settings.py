...
# SECRET_KEY = 'django-insecure-li4u*g09@m5emz2xv)mmbe#t2$!qd8*b2-ornl9-)dunr6pqsb'
SECRET_KEY = os.environ.get("SECRET_KEY", "secret_key")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [".onrender.com", "localhost", "freebie.deploy.tz", "127.0.0.1"]
...
CRISPY_TEMPLATE_PACK = 'bootstrap4'  # Example for Bootstrap 4
